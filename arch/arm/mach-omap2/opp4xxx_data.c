...
#define OMAP4460_VDD_MPU_OPP50_UV                970000 //307
#define OMAP4460_VDD_MPU_OPP100_UV              1150000 //691 @ TNP
#define OMAP4460_VDD_MPU_OPPTURBO_UV            1250000 //1036 @ TNP
#define OMAP4460_VDD_MPU_OPPNITRO_UV            1275000 //1190 @ TNP
#ifdef CONFIG_OMAP_OCFREQ_1350
#define OMAP4460_VDD_MPU_OPPOVERCLOCK_UV               1300000 //1344 \ 1382
#endif
#ifdef CONFIG_OMAP_OCFREQ_1400
#define OMAP4460_VDD_MPU_OPPNITRO_UV_OC1400 1310000
#endif
#ifdef CONFIG_OMAP_OCFREQ_1600
#define OMAP4460_VDD_MPU_OPPNITRO_UV_OC1600 1350000
#endif
#ifdef CONFIG_OMAP_OCFREQ_1800
#define OMAP4460_VDD_MPU_OPPNITRO_UV_OC1800 1400000
#endif
...
struct omap_volt_data omap446x_vdd_mpu_volt_data[] = {
...
#ifdef CONFIG_OMAP_OCFREQ_1350
        VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPPOVERCLOCK_UV, 10000, OMAP44XX_CONTROL_FUSE_MPU_OPPNITRO, 0, 0, 0xff, 0x2a, OMAP_ABB_FAST_OPP),
#endif
#ifdef CONFIG_OMAP_OCFREQ_1400
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPPNITRO_UV_OC1400, 0, 0, 0, 0, 0xff, 0x2a, OMAP_ABB_FAST_OPP),
#endif
#ifdef CONFIG_OMAP_OCFREQ_1600
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPPNITRO_UV_OC1600, 0, 0, 0, 0, 0xff, 0x2a, OMAP_ABB_FAST_OPP),
#endif
#ifdef CONFIG_OMAP_OCFREQ_1800
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPPNITRO_UV_OC1800, 0, 0, 0, 0, 0xff, 0x2a, OMAP_ABB_FAST_OPP),
#endif
#ifdef CONFIG_OMAP_OCFREQ_2000
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPPNITRO_UV_OC2000, 0, 0, 0, 0, 0xff, 0x2a, OMAP_ABB_FAST_OPP),
#endif
	VOLT_DATA_DEFINE(0, 0, 0, 0, 0, 0, 0, 0),
};
#else
	...
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPPNITRO_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITRO, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
        VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPPOVERCLOCK_UV, 10000, OMAP44XX_CONTROL_FUSE_MPU_OPPNITRO, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(0, 0, 0, 0, 0, 0),
};
#endif
...
#define OMAP4460_VDD_CORE_OPP100_UV		 980000
#define OMAP4460_VDD_CORE_OPP100_OV_UV		1070000
...
static struct omap_vdd_dep_volt omap446x_vdd_mpu_core_dep_data[] = {
	...
	#ifdef CONFIG_OMAP_OCFREQ_1350
        {.main_vdd_volt = OMAP4460_VDD_MPU_OPPOVERCLOCK_UV, .dep_vdd_volt = OMAP4460_VDD_CORE_OPP100_UV},
	#endif
	#ifdef CONFIG_OMAP_OCFREQ_1400
...
static struct omap_opp_def __initdata omap446x_opp_def_list[] = {
	...
	#ifdef CONFIG_OMAP_OCFREQ_1350
	OPP_INITIALIZER("mpu", "virt_dpll_mpu_ck", "mpu", false, 1350000000, OMAP4460_VDD_MPU_OPPOVERCLOCK_UV),
	#endif
	/* L3 OPP1 - OPP50 */
	#ifdef CONFIG_OMAP_OCFREQ_1400
